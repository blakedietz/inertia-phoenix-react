...
config :app, AppWeb.Endpoint,
  ...
  live_view: [signing_salt: "954+EHoK"]
...
config :esbuild,
  ...
  app: [
    args:
      ~w(js/app.tsx --bundle --chunk-names=chunks/[name]-[hash] --splitting --format=esm --target=es2020 --outdir=../priv/static/assets --external:/fonts/* --external:/images/* --alias:@=./js),
